...
<html>
    <head>
        <title>TuhiWeb/Registrarse</title>
    ...
    <body>
        ...
        <img class="imagenFondo" src="/TurboWeb/Recursos/Imagenes/presaChanza.JPG" alt="" width="100%" height="100%"/>
        ...
        <section class="p">
            ...
            <div style="background: white;">
                <form  action="/TurboWeb/Controlador/GuardarRegistro" method="POST" enctype="multipart/form-data" onsubmit="return contrasenasIguales()">

                    <h2 class="titulo">Registrarse</h2>

                    <input required class="campoR" id="correo" name="correo"  type="email" placeholder="Correo"/>
                    <input required class="campoR" id="dni" name="dni" type="text" placeholder="DNI"/>
                    <input required class="campoR" id="nombre" name="nombre" type="text" placeholder="Nombre"/>
                    <input required class="campoR" id="apellidos" name="apellidos" type="text" placeholder="Apellidos"/>
                    <input required class="campoR" id="tlf" name="tlf" type="text" placeholder="Número de telefono" pattern="[0-9]{9}"/>
                    <input required class="campoR " id="passw1" name="passw1" type="password" placeholder="Contraseña" style=" border-color: red;"/>
                    <input required class="campoR " id="passw2" name="passw2" type="password" placeholder=" Repetir contraseña"/>
                    <p id="error"></p>
                    ...
                    <a href="/TurboWeb/Controlador/login" style="text-align: center; display: block">¿Ya estás registrado?</a>
        ...
        <script src="/TurboWeb/Recursos/js/registro-login.js" type="text/javascript"></script>
