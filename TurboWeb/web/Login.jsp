...
<html>
    <head>
        <title>TuhiWeb/Inicio de sesión</title>
    ...
    <body>
        ...
        <section class="p">
            ...
            <div class="ventana">
                <form  action="/TurboWeb/Controlador/IniciarSesion" method="POST" enctype="multipart/form-data">
 
                        <h2 class="titulo">Iniciar sesión</h2>

                        <input required class="campo" id="correo" name="correo" type="email" placeholder="Correo"/>
                        <input required class="campo" id="passw"  name="passw" type="password" placeholder="Contraseña"/>
                        ...
                        <a href="/TurboWeb/Controlador/EnlaceOlvidadoContraseña" style="text-align: center; display: block">¿Has olvidado la contraseña?</a>
                        <a href="/TurboWeb/Controlador/Registrarse" style="text-align: center; display: block">¿Necesitas cuenta?</a>
