...
<html>
    <head>
        <title>TuhiWeb/Recuperar contraseña</title>
    ...
    <body>
        ...
        <section class="p">
            ...
            <div class="ventanaR">
                <form  action="/TurboWeb/Controlador/CambiarContrasenaOlvidada" method="POST" enctype="multipart/form-data" onsubmit="return contrasenasIguales()">
                    ...
                    <input required class="campoR " id="passw1" name="passw1" type="password" placeholder="Nueva Contraseña" style=" border-color: red;"/>
                    <input required class="campoR " id="passw2" name="passw2" type="password" placeholder=" Repetir nueva contraseña"/>
                    <p id="error"></p>
                    <c:if test="${requestScope.mensajeError!=null}"><p id="errorServidor">${requestScope.mensajeError}</p></c:if>

                    <input class="enviar" type="submit" value="Cambiar contraseña" />

                    <a href="/TurboWeb/Controlador/login" style="text-align: center; display: block">Quiero mantener la contraseña actual</a>
