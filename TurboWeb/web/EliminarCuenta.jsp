...
<html>
    <head>
        <title>TuhiWeb/Eliminar cuenta</title>
    ...
    <body>
        ...
        <section class="p">
            ...
            <div class="ventana">
                <form  action="/TurboWeb/Controlador/EliminarCuenta" method="POST" enctype="multipart/form-data">
 
                        <h2 class="titulo">Eliminar cuenta</h2>
                        ...
                        <input class="enviar" type="submit" value="Eliminar cuenta" style="margin-bottom: 15%;" />
