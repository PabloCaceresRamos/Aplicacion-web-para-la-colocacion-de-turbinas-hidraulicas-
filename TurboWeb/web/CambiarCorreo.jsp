...
<html>
    ...
    <body>
        ...
        <section class="p">
            ...
            <div class="ventana">
                <form  action="/TurboWeb/Controlador/CambiarCorreo" method="POST" enctype="multipart/form-data">
 
                        <h2 class="titulo">Cambiar correo</h2>

                        <input required class="campo" id="correo" name="nuevoCorreo" type="email" placeholder="Nuevo correo"/>
                        ...
                        <input class="enviar" type="submit" value="Cambiar correo" />
